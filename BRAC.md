...
> **Note:** It is assumed that `spatialite_gui` and `spatialite_tool` are installed and available through the command line.

## Steps:

1. Make sure that no `BRAC.sqlite` file exists in your current directory.
